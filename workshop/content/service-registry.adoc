...
. Click on the `Product Catalog API` to  view the details of the ProductCatalogAPI schema. This overview page provides details about this registry. You will find details about the schemna on this page. 
+
...
In the next step you will explore use the ProductCatalogAPI specifications to setup mocks.
