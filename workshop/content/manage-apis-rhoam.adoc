...
. You will see that a sample API which has been already setup.
+
...
[NOTE]
====
*Instruction how to access the Private Endpoint of the* `*Product Catalog API*`
...
* Under the `Resources` tab, copy the `Location` URLas present at the bottom of this under `Routes`. This would look something like this `https://catalog-globex-user1.apps.cluster-fzxlb.fzxlb.sandbox1043.opentlc.com`
